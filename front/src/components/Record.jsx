...
export default function RecordTab({ records }) {
        ...
        {records &&
          records.map((record, index) => (
            ...
            <div key={index} className="flex gap-6 mb-3 items-center px-4 py-2 bg-white rounded-xl ">
              ...
              <div
                key={index}
                className={`w-[40px] h-[40px] flex justify-center items-center rounded-[20px]`}
                style={{
                  background: `${record.transaction_type === "EXP" ? "#F54949" : "#0166FF"
                    }`
                }}
              >
                <img
              ...
              <div className="flex justify-between w-[950px]">
                ...
                <div className="flex items-center">
                  <p
                    ...
                    style={{
                      color: `${record.transaction_type === "EXP" ? "#F54949" : "#0166FF"
                        }`
                    }}
                  >
                    {record.amount}
