...
export default function RecordADDcategory({ records, setRecords }) {
  ...
  const handleAddRecord = async () => {
    try {
      // Create a new transaction with additional details
            ...
            <div className="fixed top-[30%] left-[40%]  ">
              <div className="bg-white text-black w-[440px] flex-col flex rounded-3xl border-solid border-[1px] ">
                <div className="flex justify-between">
                  ...
                  <p onClick={() => recordModalHandler(false)} className="p-5">
                    x
                  </p>
                </div>
                <hr></hr>
                ...
                <input   type="text" placeholder="Transaction Name" value={transactionName}   onChange={(e) => setTransactionName(e.target.value)}/>
                <input placeholder="Transaction Description" value={transactionDescription} onChange={(e) => setTransactionDescription(e.target.value)} />
